...
pygame.display.set_caption("Infinite Maze ver 0.4")
...
pacman_sprites = [
    pygame.image.load("pacman_closed.png"),
    pygame.image.load("pacman_half.png"),
    pygame.image.load("pacman_open.png")
]
pacman_sprites = [pygame.transform.scale(sprite, (CELL_SIZE, CELL_SIZE)) for sprite in pacman_sprites]
...
class Pacman:
    ...
    def get_sprite(self):
        """Анимация Pac-Man'а"""
        self.frame = (self.frame + 1) % len(pacman_sprites)
        return pacman_sprites[self.frame]
